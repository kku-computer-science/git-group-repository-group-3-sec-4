...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            ...
            <a class="btn btn-primary btn-icon-text btn-sm" href="<?php echo e(route('users.create')); ?>"><i class="ti-plus btn-icon-prepend icon-sm"></i><?php echo e(__('users.new_user')); ?></a>
            <a class="btn btn-primary btn-icon-text btn-sm" href="<?php echo e(route('importfiles')); ?>"><i class="ti-download btn-icon-prepend icon-sm"></i><?php echo e(__('users.import_new_use')); ?></a>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/users/index.blade.php ENDPATH**/ ?>