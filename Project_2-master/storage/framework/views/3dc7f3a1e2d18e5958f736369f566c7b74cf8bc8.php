...
<div class="container">
    ...
    <form action="<?php echo e(route('papers.destroy',$paper->id)); ?>" method="POST">
        ...
        <li class="list-inline-item">
            <a class="btn btn-outline-primary btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('papers.view_tooltip')); ?>" href="<?php echo e(route('papers.show',$paper->id)); ?>"><i class="mdi mdi-eye"></i></a>
        </li>
        <?php if(Auth::user()->can('update',$paper)): ?>
        <li class="list-inline-item">
            <a class="btn btn-outline-success btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('papers.edit_tooltip')); ?>" href="<?php echo e(route('papers.edit',Crypt::encrypt($paper->id))); ?>"><i class="mdi mdi-pencil"></i></a>
        </li>
        <?php endif; ?>
        <!-- <?php echo csrf_field(); ?>
        ...
        <li class="list-inline-item">
         <button class="btn btn-outline-danger btn-sm show_confirm" type="submit"
                data-toggle="tooltip" data-placement="top" title="<?php echo e(__('papers.delete_tooltip')); ?>"><i class="mdi mdi-delete"></i></button>
        </li> -->
...
<script type="text/javascript">
    $('.show_confirm').click(function(event) {
        ...
        swal({
                title: "<?php echo e(trans('papers.are_you_sure')); ?>",
                text: "<?php echo e(trans('papers.if_delete_gone')); ?>",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    swal("<?php echo e(trans('papers.delete_success')); ?>", {
                        icon: "success",
                    }).then(function() {
                        location.reload();
                        form.submit();
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/papers/index.blade.php ENDPATH**/ ?>