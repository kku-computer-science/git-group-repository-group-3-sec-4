            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="<?php echo e(route('books.update',$book->id)); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="ac_name" value="<?php echo e($book->ac_name); ?>" class="form-control" placeholder="name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleInputac_sourcetitle" class="col-sm-3 col-form-label">สถานที่ตีพิมพ์</label>
                        <div class="col-sm-9">
                            <input type="text" name="ac_sourcetitle" value="<?php echo e($book->ac_sourcetitle); ?>" class="form-control" placeholder="สถานที่ตีพิมพ์">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleInputac_year" class="col-sm-3 col-form-label">ปีที่เผยแพร่ (พ.ศ.)</label>
                        <div class="col-sm-9">
                            <input type="date" name="ac_year" value="<?php echo e($book->ac_year); ?>" class="form-control" placeholder="ปีที่เผยแพร่ (พ.ศ.)">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="exampleInputac_page" class="col-sm-3 col-form-label">จำนวนหน้า (Page)</label>
                        <div class="col-sm-9">
                            <input type="text" name="ac_page" value="<?php echo e($book->ac_page); ?>" class="form-control" placeholder="จำนวนหน้า (Page)">
                        </div>
                    </div>

                    <!-- เปลี่ยนปุ่มให้ใช้การแปล -->
                    <button type="submit" class="btn btn-primary me-2">
                        <?php echo e(__('books.submit_button')); ?>

                    </button>
                    <a class="btn btn-light" href="<?php echo e(route('books.index')); ?>">
                        <?php echo e(__('books.cancel_button')); ?>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/books/edit.blade.php ENDPATH**/ ?>