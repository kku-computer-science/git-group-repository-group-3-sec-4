...
<div class="container cardprofile mt-5">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6">
                <div class="card-body">
                    ...
                    <h6 class="card-text1"><?php echo e(trans('books.email')); ?>: <?php echo e($res->email); ?></h6>
                    ...
                    <?php $__currentLoopData = $res->education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h6 class="card-text2 col-sm-10">
                            ...
                            <?php echo e($edu->{'qua_name_' . (app()->getLocale() == 'zh' ? 'cn' : (app()->getLocale() == 'en' ? 'en' : ''))} ?? $edu->qua_name); ?> 
                            <?php echo e($edu->{'uname_' . (app()->getLocale() == 'zh' ? 'cn' : (app()->getLocale() == 'en' ? 'en' : ''))} ?? $edu->uname); ?>
            ...
            <div class="col-md-4">
                <h6 class="title-pub"><?php echo e(trans('books.publications')); ?></h6>
    ...
    <button class="nav-link" id="book-tab" data-bs-toggle="tab" data-bs-target="#book" type="button" role="tab" aria-controls="book" aria-selected="false">
        <?php echo e(trans('books.book')); ?>

    </button>
</li>
       <li class="nav-item" role="presentation">
    <button class="nav-link" id="patent-tab" data-bs-toggle="tab" data-bs-target="#patent" type="button" role="tab" aria-controls="patent" aria-selected="false">
        <?php echo e(trans('books.patent')); ?>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="tab-content" style="padding-bottom: 20px;">
                <a class="btn btn-success" href="<?php echo e(route('excel', ['id' => $res->id])); ?>" target="_blank"><?php echo e(trans('books.export_excel')); ?></a>
            </div>
    ...
    <tr>
        <th><?php echo e(trans('books.no')); ?></th>
        <th><?php echo e(trans('books.year')); ?></th>
        <th><?php echo e(trans('books.paper_name')); ?></th>
        <th><?php echo e(trans('books.author')); ?></th>
        <th><?php echo e(trans('books.document_type')); ?></th>
        <th><?php echo e(trans('books.page')); ?></th>
        <th><?php echo e(trans('books.journal_transactions')); ?></th>
        <th><?php echo e(trans('books.citations')); ?></th>
        <th><?php echo e(trans('books.doi')); ?></th>
        <th><?php echo e(trans('books.source')); ?></th>
    </tr>
</thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(app()->getLocale() == 'th' ? $paper->paper_yearpub + 543 : $paper->paper_yearpub); ?></td>
                        ...
                        <td>
                            ...
                            <span>
                                <a>
                                    <?php if(app()->getLocale() == 'th'): ?>
                                        <?php echo e($author->author_fname_th ?? $author->author_fname); ?> <?php echo e($author->author_lname_th ?? $author->author_lname); ?>

                                    <?php else: ?>
                                        <?php echo e($author->fname_en ?? $author->author_fname); ?> <?php echo e($author->lname_en ?? $author->author_lname); ?>
                            ...
                            <span>
                                <a href="<?php echo e(route('detail', Crypt::encrypt($author->id))); ?>">
                                    <teacher>
                                        <?php if(app()->getLocale() == 'th'): ?>
                                            <?php echo e($author->fname_th ?? $author->fname_en); ?> <?php echo e($author->lname_th ?? $author->lname_en); ?>
                        ...
                        <td>
                            <?php if(app()->getLocale() == 'th'): ?>
                                <?php echo e($paper->paper_type_th); ?>

                            <?php elseif(app()->getLocale() == 'zh'): ?>
                                <?php echo e($paper->paper_type_cn); ?>
        ...
        <div class="tab-pane fade" id="book" role="tabpanel" aria-labelledby="book-tab">
            <table id="example5" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th><?php echo e(trans('books.Number')); ?></th>
                        <th><?php echo e(trans('books.year')); ?></th>
                        <th><?php echo e(trans('books.Name')); ?></th>
                        <th><?php echo e(trans('books.author')); ?></th>
                        <th><?php echo e(trans('books.Place of printing')); ?></th>
                        <th><?php echo e(trans('books.page')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(app()->getLocale() == 'th'): ?>
                                <?php echo e($paper->ac_name ?? $paper->ac_name_en); ?>

                            <?php elseif(app()->getLocale() == 'zh'): ?>
                                <?php echo e($paper->ac_name_cn ?? $paper->ac_name_en); ?>

                            <?php else: ?>
                                <?php echo e($paper->ac_name_en ?? $paper->ac_name); ?>
                        ...
                        <td>
                            <?php if(app()->getLocale() == 'th'): ?>
                                <?php echo e($paper->ac_sourcetitle ?? $paper->ac_sourcetitle_en); ?>

                            <?php elseif(app()->getLocale() == 'zh'): ?>
                                <?php echo e($paper->ac_sourcetitle_cn ?? $paper->ac_sourcetitle_en); ?>

                            <?php else: ?>
                                <?php echo e($paper->ac_sourcetitle_en ?? $paper->ac_sourcetitle); ?>
            ...
            <table id="example6" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(trans('books.Name')); ?></th>
                        <th><?php echo e(trans('books.author')); ?></th>
                        <th><?php echo e(trans('books.Type')); ?></th>
                        <th><?php echo e(trans('books.Registration number')); ?></th>
                        <th><?php echo e(trans('books.Registration date')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span>
                                <a>
                                    ...
                                    <?php else: ?>
                                        <?php echo e($author->author_fname); ?> <?php echo e($author->author_lname); ?>
                        ...
                        <td>
                            <?php if(app()->getLocale() == 'th'): ?>
                                <?php echo e($paper->ac_type_th ?? $paper->ac_type); ?>

                            <?php elseif(app()->getLocale() == 'zh'): ?>
                                <?php echo e($paper->ac_type_cn ?? $paper->ac_type); ?>

                            <?php else: ?>
                                <?php echo e($paper->ac_type ?? $paper->ac_type); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/researchprofiles.blade.php ENDPATH**/ ?>