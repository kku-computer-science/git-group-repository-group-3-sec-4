...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title"><?php echo e(__('researchGroups.research_group')); ?></h4>
            <a class="btn btn-primary btn-menu btn-icon-text btn-sm mb-3" href="<?php echo e(route('researchGroups.create')); ?>"><i
                    class="mdi mdi-plus btn-icon-prepend"></i> <?php echo e(__('researchGroups.add')); ?></a>
            <!-- <div class="table-responsive"> -->
            <table id="example1" class="table table-striped">
                <thead>
                    <tr>
                        <th><?php echo e(__('researchGroups.no')); ?></th>
                        <th><?php echo e(__('researchGroups.group_name')); ?></th>
                        <th><?php echo e(__('researchGroups.head')); ?></th>
                        <th><?php echo e(__('researchGroups.member')); ?></th>
                        <th width="280px"><?php echo e(__('researchGroups.action')); ?></th>
                    </tr>
                </thead>
                        ...
                        <td>
                            <form action="<?php echo e(route('researchGroups.destroy', $researchGroup->id)); ?>" method="POST">
                                ...
                                <a class="btn btn-outline-primary btn-sm"
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="<?php echo e(trans('researchGroups.view_tooltip')); ?>"
                                ...
                                <a class="btn btn-outline-success btn-sm"
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="<?php echo e(trans('researchGroups.edit_tooltip')); ?>"
                                ...
                                <button class="btn btn-outline-danger btn-sm show_confirm"
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="<?php echo e(trans('researchGroups.delete_tooltip')); ?>">
...
<script type="text/javascript">
    $('.show_confirm').click(function(event) {
        ...
        swal({
            title: "<?php echo e(trans('researchGroups.are_you_sure')); ?>",
            text: "<?php echo e(trans('researchGroups.if_delete_gone')); ?>",
            icon: "warning",
            /* จากเดิม buttons: true, แก้เป็นแบบ object เพื่อใส่ text ที่จะแปล */
            buttons: {
                cancel: {
                    text: "<?php echo e(trans('researchGroups.cancel_button')); ?>", // ปุ่มยกเลิก
                    value: null,
                    visible: true,
                ...
                confirm: {
                    text: "<?php echo e(trans('researchGroups.ok_button')); ?>",    // ปุ่มตกลง
                    value: true,
                    visible: true,
        ...
        .then((willDelete) => {
            if (willDelete) {
                swal("<?php echo e(trans('researchGroups.delete_success')); ?>", {
                    icon: "success",
                    buttons: {
                        confirm: {
                            text: "<?php echo e(trans('researchGroups.ok_button')); ?>",
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/research_groups/index.blade.php ENDPATH**/ ?>