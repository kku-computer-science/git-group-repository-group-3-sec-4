        ...
        <div class="row g-0">
            <div class="col-md-4">
                <div class="card-body">
                    ...
                    <h1 class="card-text-1"><?php echo e(trans('books.laboratory_supervisor')); ?></h1>
                    ...
                    <h1 class="card-text-1"><?php echo e(trans('books.student')); ?></h1>
                    <h2 class="card-text-2">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/researchgroupdetail.blade.php ENDPATH**/ ?>