...
<div class="container card-3 ">
    <p><?php echo e(trans('books.research_group')); ?></p>
        ...
        <div class="row g-0">
            <div class="col-md-4">
                <div class="card-body">
                    ...
                    <h2 class="card-text-1"><?php echo e(trans('books.laboratory_supervisor')); ?></h2>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <h3 class="card-text"><?php echo e(Str::limit($rg->{'group_desc_'.app()->getLocale()}, 350)); ?></h3>
                </div>
                <div>
                    <a href="<?php echo e(route('researchgroupdetail',['id'=>$rg->id])); ?>" class="btn btn-outline-info">
                        <?php echo e(trans('books.details')); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/research_g.blade.php ENDPATH**/ ?>