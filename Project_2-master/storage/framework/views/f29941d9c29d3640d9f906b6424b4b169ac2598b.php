            ...
            <div class="tab-pane " id="account" role="tabpanel" aria-labelledby="account-tab">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(route('adminUpdateInfo')); ?>" id="AdminInfoForm">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e(__('profile.fname_th')); ?><</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="newpassword" placeholder="<?php echo e(__('profile.Enter new password')); ?>" name="newpassword">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="cnewpassword" placeholder="<?php echo e(__('profile.ReEnter new password')); ?>" name="cnewpassword">
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/dashboards/users/profile.blade.php ENDPATH**/ ?>