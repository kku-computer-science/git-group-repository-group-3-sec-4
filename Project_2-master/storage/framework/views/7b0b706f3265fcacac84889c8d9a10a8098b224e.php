...
<div class="container">
    ...
    <div class="col-md-10 grid-margin stretch-card">
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title"><?php echo e(__('papers.edit_paper')); ?></h4>
                ...
                <form class="forms-sample" action="<?php echo e(route('papers.update',$paper->id)); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="paper_name" value="<?php echo e($paper->paper_name); ?>" class="form-control" placeholder="<?php echo e(__('papers.paper_name')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="abstract" placeholder="<?php echo e(__('papers.abstract')); ?>" class="form-control form-control-lg" style="height:150px"><?php echo e($paper->abstract); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="keyword" value="<?php echo e($paper->keyword); ?>" class="form-control" placeholder="<?php echo e(__('papers.keyword')); ?>">
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/papers/edit.blade.php ENDPATH**/ ?>