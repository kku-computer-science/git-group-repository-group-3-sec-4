        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="<?php echo e(asset('img/banner1_en.png')); ?>" class="d-block w-100" alt="...">
                    <?php elseif(app()->getLocale() == 'th'): ?>
                    <img src="<?php echo e(asset('img/banner1_th.png')); ?>" class="d-block w-100" alt="...">
                    <?php elseif(app()->getLocale() == 'zh'): ?>
                    <img src="<?php echo e(asset('img/banner1_cn.png')); ?>" class="d-block w-100" alt="...">
                    <?php endif; ?>
                </div>
                <div class="carousel-item">
                    <?php if(app()->getLocale() == 'en'): ?>
                    <img src="<?php echo e(asset('img/banner2en.png')); ?>" class="d-block w-100" alt="...">
                    <?php elseif(app()->getLocale() == 'th'): ?>
                    <img src="<?php echo e(asset('img/banner2th.png')); ?>" class="d-block w-100" alt="...">
                    <?php elseif(app()->getLocale() == 'zh'): ?>
                    <img src="<?php echo e(asset('img/banner2cn.png')); ?>" class="d-block w-100" alt="...">
                    <?php endif; ?>
                </div>
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                ...
                <span class="visually-hidden"><?php echo e(trans('message.Previous')); ?></span>
            </button>
    ...
    <div class="modal" id="myModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h5 class="modal-title"><?php echo e(__('message.Reference (APA)')); ?></h5>
                        ...
                        <div class="row mt-2 mb-3 border-bottom">
                            ...
                            <div id="paper2" class="col-sm-11">
                                <p class="hidden">
                                    ...
                                    <button style="padding: 0;"class="btn btn-link open_modal" value="<?php echo e($p['id']); ?>"><?php echo e(__('message.ref')); ?></button>
...
<script>
    ...
    let currentLocale = '<?php echo e(app()->getLocale()); ?>';
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/home.blade.php ENDPATH**/ ?>