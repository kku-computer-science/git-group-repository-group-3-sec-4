...
<div class="container">
    ...
    <div class="card" style="padding: 16px;">
        <div class="card-body">
            <h4 class="card-title" style="text-align: center;"><?php echo e(__('manageExpertise.teacher_expertise')); ?></h4>
            <table id="example1" class="table table-striped">
                <thead>
                    <tr>
                        <th><?php echo e(__('manageExpertise.id')); ?></th>
                        <?php if(Auth::user()->hasRole('admin')): ?>
                        <th><?php echo e(__('manageExpertise.teacher_name')); ?></th>
                        <?php endif; ?>
                        <th><?php echo e(__('manageExpertise.name')); ?></th>

                        <th><?php echo e(__('manageExpertise.action')); ?></th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <form action="<?php echo e(route('experts.destroy',$expert->id)); ?>" method="POST">
                                ...
                                <li class="list-inline-item">
                                    <a class="btn btn-outline-success btn-sm"
                                        ...
                                        data-placement="top"
                                        title="<?php echo e(trans('manageExpertise.edit_tooltip')); ?>"
                                ...
                                <li class="list-inline-item">
                                    <button class="btn btn-outline-danger btn-sm show_confirm"
                                        ...
                                        data-toggle="tooltip"
                                        data-placement="top"
                                        title="<?php echo e(trans('manageExpertise.delete_tooltip')); ?>">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong><?php echo e(__('manageExpertise.name')); ?>:</strong>
                                <input type="text" name="expert_name" id="expert_name" class="form-control" placeholder="<?php echo e(__('manageExpertise.enter_name')); ?>" onchange="validate()">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <button type="submit" id="btn-save" name="btnsave" class="btn btn-primary " disabled><?php echo e(__('manageExpertise.submit')); ?></button>
                            <a href="<?php echo e(route('experts.index')); ?>" class="btn btn-danger"><?php echo e(__('manageExpertise.cancel')); ?></a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#edit-expertise', function() {
            ...
            $.get('experts/' + expert_id + '/edit', function(data) {
                $('#expertiseCrudModal').html("<?php echo e(trans('manageExpertise.edit_modal_title')); ?>");
        ...
        $('body').on('click', '#delete-expertise', function(e) {
            ...
            swal({
                title: "<?php echo e(trans('manageExpertise.are_you_sure')); ?>",
                text: "<?php echo e(trans('manageExpertise.cant_recover')); ?>",
                icon: "warning", // เปลี่ยน type -> icon เพื่อให้ใช้งานรูปแบบใหม่
                buttons: {
                    cancel: "<?php echo e(trans('manageExpertise.cancel_button')); ?>",  // ปุ่มยกเลิก
                    confirm: "<?php echo e(trans('manageExpertise.ok_button')); ?>"       // ปุ่มตกลง
                },
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete) {
                    swal("<?php echo e(trans('manageExpertise.delete_success')); ?>", {
                        icon: "success",
                    }).then(function() {
                        location.reload();
                        $.ajax({
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/expertise/index.blade.php ENDPATH**/ ?>