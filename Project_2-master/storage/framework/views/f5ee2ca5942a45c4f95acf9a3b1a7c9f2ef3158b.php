            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text"><?php echo e(__('dashboard.welcome_text')); ?><span
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        document.getElementById ('logout-form').submit();"> <?php echo e(__('menudashboard.logout')); ?> <i class="mdi mdi-logout"></i></a>
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('dashboard*')) ? 'active' : ''); ?>"
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.dashboard')); ?></span>
                        </a>
                    </li>
                    <li class="nav-item nav-category"><?php echo e(__('menudashboard.Profile')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((request()->is('admin/profile*')) ? 'active' : ''); ?>"
                            href="<?php echo e(route('profile')); ?>">
                            <i class="menu-icon mdi mdi-account-circle-outline"></i>
                            <span class="menu-title"><?php echo e(__('menudashboard.user_profile')); ?></span>
                    ...
                    <li class="nav-item nav-category"><?php echo e(__('menudashboard.Option')); ?></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('funds.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.manage_fund')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchProjects.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.research_project')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('researchGroups.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.research_group')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.manage_publications')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('papers.index')); ?>"><?php echo e(__('menudashboard.published_research')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books"><?php echo e(__('menudashboard.book')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents"><?php echo e(__('menudashboard.other_academic_works')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('exportfile')); ?>" >
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.export')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                    <li class="nav-item nav-category"><?php echo e(__('menudashboard.Admin')); ?></li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('users.index')); ?>">
                            <i class="menu-icon mdi mdi-account-multiple-outline"></i>
                            <span class="menu-title"><?php echo e(__('menudashboard.users')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('roles.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.roles')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('permissions.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.permissions')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('departments.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.departments')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('programs.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.programs')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('experts.index')); ?>">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.expertise')); ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#systemLogMenu" aria-expanded="false" aria-controls="systemLogMenu">
                            ...
                            <span class="menu-title"><?php echo e(__('menudashboard.system_log')); ?></span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="systemLogMenu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('log.index')); ?>"><?php echo e(__('menudashboard.All Logs')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('log.login')); ?>"><?php echo e(__('menudashboard.Login Logs')); ?></a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('log.error')); ?>"><?php echo e(__('menudashboard.Error Logs')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                    <?php endif; ?>
...
</html><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>