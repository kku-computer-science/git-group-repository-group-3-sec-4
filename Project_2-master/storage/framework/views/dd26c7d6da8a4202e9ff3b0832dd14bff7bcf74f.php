                                ...
                                <form action="<?php echo e(route('funds.destroy',$fund->id)); ?>" method="POST">
                                    <li class="list-inline-item">
                                        <a class="btn btn-outline-primary btn-sm"
                                            ...
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="<?php echo e(trans('funds.view_tooltip')); ?>"
                                            href="<?php echo e(route('funds.show',$fund->id)); ?>">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="btn btn-outline-success btn-sm"
                                            ...
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="<?php echo e(trans('funds.edit_tooltip')); ?>"
                                            href="<?php echo e(route('funds.edit',Crypt::encrypt($fund->id))); ?>">
                                    ...
                                    <li class="list-inline-item">
                                        ...
                                        <button class="btn btn-outline-danger btn-sm show_confirm"
                                            type="submit"
                                            data-toggle="tooltip"
                                            title="<?php echo e(trans('funds.delete_tooltip')); ?>">
...
<script type="text/javascript">
    $('.show_confirm').click(function(event) {
        ...
        swal({
                title: "<?php echo e(trans('funds.are_you_sure')); ?>",
                text: "<?php echo e(trans('funds.if_delete_gone')); ?>",
                icon: "warning",
                buttons: {
                    cancel: {
                        text: "<?php echo e(trans('funds.cancel')); ?>",
                        value: null,
                        visible: true,
                    ...
                    confirm: {
                        text: "<?php echo e(trans('funds.ok')); ?>",
                        value: true,
                        visible: true,
            ...
            .then((willDelete) => {
                if (willDelete) {
                    swal({
                        title: "<?php echo e(trans('funds.delete_success')); ?>",
                        icon: "success",
                        buttons: {
                            confirm: {
                                text: "<?php echo e(trans('funds.ok')); ?>",
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/funds/index.blade.php ENDPATH**/ ?>