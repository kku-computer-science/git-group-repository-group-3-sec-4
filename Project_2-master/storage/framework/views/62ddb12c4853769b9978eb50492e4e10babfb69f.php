...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title" style="padding: 16px;"><?php echo e(trans('books.report_title')); ?></h4>
                <div class="row">
...
<div class="container card-cart d-sm-flex  justify-content-center mt-5">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title" style="padding: 16px;"><?php echo e(trans('books.report_citations')); ?></h5>
                <div class="row">
                    <div class="col-md-6 p-5">
                        <div style="width:520px;height:250px">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/report.blade.php ENDPATH**/ ?>