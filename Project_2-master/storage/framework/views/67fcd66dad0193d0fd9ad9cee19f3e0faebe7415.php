    ...
    <div class="justify-content-center">
        ...
        <div class="card">
            <div class="card-header"><?php echo e(__('department.department')); ?>
                ...
                <a class="btn btn-primary" href="<?php echo e(route('departments.create')); ?>"><?php echo e(__('department.new_department')); ?></a>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/departments/index.blade.php ENDPATH**/ ?>