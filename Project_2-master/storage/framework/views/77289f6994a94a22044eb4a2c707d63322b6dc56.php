    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    ...
                    <li
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php $__currentLoopData = $dn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('researchers',['id'=>$department->id])); ?>">
                                        <?php if(App::getLocale() == 'th'): ?>
                                            <?php echo e($department->program_name_th); ?>

                                        <?php elseif(App::getLocale() == 'zh'): ?>
                                            <?php echo e($department->programs_name_cn); ?>
                ...
                <?php else: ?>
                <span class="nav-item">
                    <a class="btn-solid-sm" href="/login" target="_blank"><?php echo e(__('message.Login')); ?></a>
                </span>
                <?php endif; ?>
                <?php endif; ?>
...
</html><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/layouts/layout.blade.php ENDPATH**/ ?>