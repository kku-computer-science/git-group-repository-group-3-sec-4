                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php echo Form::select('roles[]', $localizedRoles, [], [
                            'class' => 'selectpicker',
                            'multiple',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        catElem.oninvalid = function(e) {
            e.target.setCustomValidity("<?php echo e(trans('users.select_cat_error')); ?>");
        };
        ...
        subcatElem.oninvalid = function(e) {
            e.target.setCustomValidity("<?php echo e(trans('users.select_subcat_error')); ?>");
        };
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/users/create.blade.php ENDPATH**/ ?>