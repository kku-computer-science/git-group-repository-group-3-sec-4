...
<div class="container">
    <div class="justify-content-center">
        ...
        <?php endif; ?>
        <div class="card">
            <div class="card-header"><?php echo e(__('department.create_department')); ?>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/departments/create.blade.php ENDPATH**/ ?>