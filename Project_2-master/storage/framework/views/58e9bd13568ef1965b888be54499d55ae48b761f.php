    ...
    <div class="justify-content-center">
        ...
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                ...
                <a class="btn btn-primary btn-menu btn-icon-text btn-sm mb-3" href="<?php echo e(route('roles.create')); ?>"><i class="mdi mdi-plus btn-icon-prepend"></i><?php echo e(__('roles.add')); ?></a>
                <?php endif; ?>
...
<?php echo $__env->make('dashboards.users.layouts.user-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Documents\GitHub\git-group-repository-group-3-sec-4\Project_2-master\resources\views/roles/index.blade.php ENDPATH**/ ?>