...
${EXPECTED_THAI_TEXT}    สถิติจำนวนบทความทั้งหมด 5 ปี 
${EXPECTED_ENGLISH_TEXT}    Statistics of articles in the last 5 years
${EXPECTED_CHINESE_TEXT}    过去5年的文章统计
...
Switch From English To Thai
    ...
    Verify Report Page Text    ${EXPECTED_THAI_TEXT}
...
Switch From English To Chinese
    ...
    Verify Report Page Text    ${EXPECTED_CHINESE_TEXT}
